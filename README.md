...
# 👋 안녕하세요, AI 개발자 **이창민**입니다.

문제가 발생하면 원인을 찾을 때까지 깊게 파고드는 집요함을 강점으로 합니다.  
LLM 파인튜닝, RAG 파이프라인 구축, 데이터 처리, 백엔드 개발까지  
AI 기술을 **실제 제품으로 구현하는 데 필요한 전 과정을 직접 수행할 수 있는 개발자**입니다.  
...
### 💡 흥미 & 관심 분야
- 🛠️ **AI 서비스 개발** · 웹 애플리케이션 개발  
- 🤖 **LLM/챗봇** · 데이터 파이프라인  
- 🎨 인터랙티브 웹 / 애니메이션 / UI·UX  
- 🧩 RAG/LLM 기반 서비스 + 애니메이션 포트폴리오 제작  

---

## 📌 제가 일할 때의 강점
- **문제를 끝까지 파고드는 집요함**  
- 불확실한 상황에서도 원인을 구조적으로 분석하는 사고력  
- “대충 되는” 코드를 만들지 않고, **원리와 개선 포인트를 반드시 확인하는 스타일**  
- 결과보다 과정의 정확성과 재현성을 더 중요하게 생각함  
